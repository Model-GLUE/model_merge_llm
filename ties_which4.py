...
root_path='/workspace/0423_tinybenchmarks/SEARCH/evo/0428_new_zoo/which4/tinybench_ties'
GPU_idx='6'
...
densities=("{weights_list[4]}" "{weights_list[5]}" "{weights_list[6]}" "{weights_list[7]}")
...
sampler = optuna.samplers.CmaEsSampler(popsize=10, sigma0=1/6, seed=42)
